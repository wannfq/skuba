...
- **template/oss-npm-package:** Install `corepack@0.31.0` and set `COREPACK_DEFAULT_TO_LATEST: 0` to mitigate https://github.com/nodejs/corepack/issues/612 ([#1778](https://github.com/seek-oss/skuba/pull/1778))
